    ...
    public static class AppBarHelper
    {
        ...
        private static void AppBarSetPosition(AppBarEdge edge, Form appBarForm)
        {
            ...
            else
            {
                ...
                barData.rc.left = Margin;
                barData.rc.right = screenRect.Width - Margin *2;

                if (edge == AppBarEdge.Top)
                {
                    // Setup proposed location
                    barData.rc.top = Margin;
                    barData.rc.bottom = barData.rc.top + regInfo.OrigSize.Height + Margin * 2;
                }
        ...
        public static void SetAppBar(Form appBarForm, AppBarEdge edge, int margin = 0)
        {
            Margin = margin;
